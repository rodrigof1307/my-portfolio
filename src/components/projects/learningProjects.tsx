export default function LearningProjects() {
    return (
        ...
        <p>
            ...
            <br/><br/>
            The current projects on this repository are:<br/>
            - <b>blockexplorer</b>: Simple <b>block explorer</b> for the <b>Ethereum</b> Blockchain using Alchemy's SDK. Developed with <b>React.js</b> and <b>Tailwind CSS</b>.<br/>
            ...
            <br/><br/>
            <b>Code repository</b> 📁: 
            <a target="_blank" href='https://github.com/rodrigof1307/learning-projects' rel="noopener noreferrer" className="underline">
